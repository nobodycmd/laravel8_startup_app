    ...
    <header class="main-header" id="main-header">
        <div class="logo">
            <div class="logo">
                ...
                <span class="logo-lg"><img src="/img/logo.png">商户后台</span>
            </div>
        </div>
...
{{--                <li><a href="href"><i class="fa fa-star-o"></i> <span>name</span></a></li>--}}
    ...
    <div id="admin_right" class="content-wrapper" style="font-size: 16px;">
        @yield('layout')
    </div>
    <!--右侧内容 结束-->
    <script>
    ...
    <aside class="control-sidebar control-sidebar-dark">
        <ul class="control-sidebar-menu">
                ...
                <li><a href="{{route('merchant.index.password')}}" style="color: #fff;"><i class="fa fa-circle-o text-yellow"></i> 修改密码</a></li>
                <li><a href="{{route('merchant.index.logout')}}" style="color: #fff;"><i class="fa fa-circle-o text-red"></i> 退出管理</a></li>
...
<script type='text/javascript'>
    //图标配置
    var icoConfig = {
        "主页":"fa-inbox","系统管理":"fa-list","订单管理":"fa-registered","数据统计":"fa-cubes","日志管理":"fa-search","订单对比":"fa-user-o","财务管理":"fa-group","换汇管理":"fa-comment-o",
        "订单管理":"fa-file-text","单据管理":"fa-files-o","发货地址":"fa-address-card-o","促销活动":"fa-bullhorn","营销活动":"fa-bell-o",
        "优惠券管理":"fa-ticket","基础数据统计":"fa-bar-chart-o","后台首页":"fa-home","日志操作记录":"fa-file-code-o",
        "商户数据统计":"fa-pie-chart","支付管理":"fa-credit-card","第三方平台":"fa-share-alt","配送管理":"fa-truck","地域管理":"fa-street-view",
        "权限管理":"fa-unlock-alt","数据库管理":"fa-database","文章管理":"fa-file-o","帮助管理":"fa-question-circle-o",
        "广告管理":"fa-flag","公告管理":"fa-bookmark-o","网站地图":"fa-sitemap","插件管理":"fa-cogs","网站管理":"fa-wrench"
    };
