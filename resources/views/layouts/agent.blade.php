...
<div class="wrapper" style="height: auto; min-height: 100%;">
    <header class="main-header" id="main-header">
        <div class="logo">
            ...
            <span class="logo-lg"><img src="/img/logo.png">代理后台</span>
        </div>
...
{{--                <li><a href="href"><i class="fa fa-star-o"></i> <span>name</span></a></li>--}}
    ...
    <aside class="control-sidebar control-sidebar-dark">
        <ul class="control-sidebar-menu">
                ...
                <li><a href="{{route('agent.index.password')}}" style="color: #fff;"><i class="fa fa-circle-o text-yellow"></i> 修改密码</a></li>
                <li><a href="{{route('agent.index.logout')}}" style="color: #fff;"><i class="fa fa-circle-o text-red"></i> 退出管理</a></li>
